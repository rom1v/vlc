...
static void
CreateDummyMediaArray(libvlc_instance_t *libvlc, libvlc_media_t *out[],
                      size_t count)
{
...
static void
DestroyMediaArray(libvlc_media_t *const array[], size_t count)
{
    for (size_t i = 0; i < count; ++i)
        libvlc_media_release(array[i]);
}
...
test_append(void)
{
    ...
    CreateDummyMediaArray(libvlc, media, 10);
...
test_insert(void)
{
    ...
    CreateDummyMediaArray(libvlc, media, 15);
...
//    CreateDummyMediaArray(libvlc, media, 16);
//
//    /* initial playlist with 10 items */
//    int ret = libvlc_playlist_Append(playlist, media, 10);
//    assert(ret == 0);
...
test_items_moved_callbacks(void)
{
    ...
    libvlc_playlist_GoTo(playlist, 3);
    ...
    libvlc_playlist_GoTo(playlist, 5);
...
test_items_removed_callbacks(void)
{
    ...
    libvlc_playlist_GoTo(playlist, 7);
...
test_prev(void)
{
    ...
    CreateDummyMediaArray(libvlc, media, 4);
    ...
    libvlc_playlist_GoTo(playlist, 2);
...
test_next(void)
{
    ...
    CreateDummyMediaArray(libvlc, media, 3);
    ...
    libvlc_playlist_GoTo(playlist, 0); /* first item */
...
test_request_insert(void)
{
    ...
    CreateDummyMediaArray(libvlc, media, 5);
...
test_request_remove_adapt(void)
{
    ...
    CreateDummyMediaArray(libvlc, media, 11);
...
test_random(void)
{
    ...
    CreateDummyMediaArray(libvlc, media, 6);
...
test_shuffle(void)
{
    ...
    libvlc_playlist_Shuffle(playlist);

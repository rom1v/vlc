...
test_request_move_adapt(void)
{
    ...
    assert(vec.data[4] == 8);
    assert(vec.data[5] == 5);
    assert(vec.data[6] == 12);
    assert(vec.data[7] == 3);
    assert(vec.data[8] == 13);
    assert(vec.data[9] == 14);
    assert(vec.data[10] == 1);
    assert(vec.data[11] == 6);
    assert(vec.data[12] == 9);
    assert(vec.data[13] == 10);
    assert(vec.data[14] == 11);

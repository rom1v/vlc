...
static media_tree_connection_t *RemoveConnection( media_tree_t *p_tree, const media_tree_connection_t *p_connection )
{
    AssertLocked( p_tree );
    media_tree_private_t *p_priv = mt_priv( p_tree );
...
void media_tree_Disconnect( media_tree_t *p_tree, const media_tree_connection_t *p_connection )
{
    media_tree_Lock( p_tree );
    media_tree_connection_t *p_conn = RemoveConnection( p_tree, p_connection );
    media_tree_Unlock( p_tree );

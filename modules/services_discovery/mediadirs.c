...
static void input_item_subtree_added(input_item_t *, input_item_node_t *,
                                     void *);
...
static void *Run( void *data )
{
    ...
    for( int i = 0; i < num_dir; i++ )
    {
        ...
        libvlc_MetadataRequest(p_sd->obj.libvlc, p_root, META_REQUEST_OPTION_NONE,
                               &input_preparser_callbacks, p_sd, -1, p_root);

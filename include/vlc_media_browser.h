/*****************************************************************************
 * vlc_media_browser.h : Manager for media sources
 *****************************************************************************
...
#ifndef VLC_MEDIA_SOURCE_MANAGER_H
#define VLC_MEDIA_SOURCE_MANAGER_H
...
/** Add a media source module */
VLC_API int media_browser_Add( media_browser_t *, const char *psz_name );

/** Remove a media source module by name */
VLC_API int media_browser_Remove( media_browser_t *, const char *psz_name );

/** Check whether a given media source is loaded */
VLC_API bool media_browser_IsMediaSourceLoaded( media_browser_t *, const char *psz_name ) VLC_DEPRECATED;

/** Query a media source */

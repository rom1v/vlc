...
struct vlc_playlist_callbacks
{
    ...
    void (*on_cleared)(vlc_playlist_t *, void *userdata);
    void (*on_items_added)(vlc_playlist_t *, int index, vlc_playlist_item_t *[], int len, void *userdata);
    void (*on_items_removed)(vlc_playlist_t *, int index, vlc_playlist_item_t *[], int len, void *userdata);
...
VLC_API void vlc_playlist_item_Hold(vlc_playlist_item_t *);
VLC_API void vlc_playlist_item_Release(vlc_playlist_item_t *);
...
VLC_API vlc_playlist_item_t *vlc_playlist_Append(vlc_playlist_t *, input_item_t *);
VLC_API vlc_playlist_item_t *vlc_playlist_Insert(vlc_playlist_t *, int index, input_item_t *);
VLC_API void vlc_playlist_RemoveAt(vlc_playlist_t *, int index);
VLC_API bool vlc_playlist_Remove(vlc_playlist_t *, vlc_playlist_item_t *);
VLC_API int vlc_playlist_IndexOf(vlc_playlist_t *, vlc_playlist_item_t *);
VLC_API int vlc_playlist_IndexOfInputItem(vlc_playlist_t *, input_item_t *);
...
VLC_API void vlc_playlist_Preparse(vlc_playlist_t *, libvlc_int_t *libvlc,
                                   input_item_t *);

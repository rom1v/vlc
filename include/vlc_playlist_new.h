...
vlc_playlist_item_GetInputItem(vlc_playlist_item_t *);
...
vlc_playlist_Get(vlc_playlist_t *, int index);
...
VLC_API vlc_playlist_item_t *
vlc_playlist_Insert(vlc_playlist_t *, int index, input_item_t *);

VLC_API void
vlc_playlist_RemoveAt(vlc_playlist_t *, int index);

VLC_API bool
vlc_playlist_Remove(vlc_playlist_t *, vlc_playlist_item_t *);

VLC_API int
vlc_playlist_IndexOf(vlc_playlist_t *, vlc_playlist_item_t *);

VLC_API int
vlc_playlist_IndexOfInputItem(vlc_playlist_t *, input_item_t *);

VLC_API enum vlc_playlist_playback_mode
vlc_playlist_GetPlaybackMode(vlc_playlist_t *);

VLC_API enum vlc_playlist_playback_order
vlc_playlist_GetPlaybackOrder(vlc_playlist_t *);

VLC_API void
vlc_playlist_SetPlaybackMode(vlc_playlist_t *, enum vlc_playlist_playback_mode);
...
VLC_API void
vlc_playlist_GoTo(vlc_playlist_t *, int index);

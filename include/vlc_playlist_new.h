...
struct vlc_playlist_callbacks
{
     ...
     */
    void
    (*on_items_updated)(vlc_playlist_t *, size_t index,
                        vlc_playlist_item_t *const items[], size_t count,
                        void *userdata);
     ...
     */
    void
    (*on_has_prev_changed)(vlc_playlist_t *, bool has_prev, void *userdata);
     ...
     */
    void
    (*on_has_next_changed)(vlc_playlist_t *, bool has_next, void *userdata);
};

...
struct libvlc_playlist_callbacks
{
     ...
     */
    void
    (*on_items_updated)(libvlc_playlist_t *playlist, size_t index,
                        libvlc_playlist_item_t *const items[], size_t count,
                        void *userdata);
     ...
     */
    void
    (*on_has_prev_changed)(libvlc_playlist_t *playlist, bool has_prev,
                           void *userdata);
     ...
     */
    void
    (*on_has_next_changed)(libvlc_playlist_t *playlist, bool has_next,
                           void *userdata);
};
 ...
 */
VLC_API libvlc_playlist_item_t *const *
libvlc_playlist_GetItems(libvlc_playlist_t *playlist);

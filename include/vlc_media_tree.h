 ...
 */
VLC_API void vlc_media_tree_AddListener(vlc_media_tree_t *, const vlc_media_tree_listener_t *);

/**
 * Remove listener. The lock must NOT be held.
 */
VLC_API void vlc_media_tree_RemoveListener(vlc_media_tree_t *, const vlc_media_tree_listener_t *);

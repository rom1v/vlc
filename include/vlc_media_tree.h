...
{
    void ( *pf_node_added )( media_tree_t *, media_node_t *p_parent, media_node_t * );
    void ( *pf_node_removed )( media_tree_t *, media_node_t * );
} media_tree_callbacks_t;

VLC_API media_tree_t *media_tree_Create( const media_tree_callbacks_t *, void *userdata );
...
VLC_API media_node_t *media_tree_AddByInput( media_tree_t *, input_item_t *, media_node_t *p_parent, int i_pos );
VLC_API media_node_t *media_tree_FindByInput( media_tree_t *, input_item_t * );
